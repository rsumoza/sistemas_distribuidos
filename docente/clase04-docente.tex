...
\section{Taller P--F--G--S--T: fallas y garantías de negocio}
Trabajar una misma garantía frente a las tres fallas del enunciado: cliente
(desconexión o reintento), infraestructura (caída o partición) y seguridad
(replay o manipulación deliberada). Remarcar que la garantía expresa un
interés de negocio o de juego y se conserva entre entregas. ``Siempre'',
``nunca'' y tiempos concretos son promesas de certeza o rendimiento, no
garantías; deben reformularse y quedar como propiedades, límites o costos de
la solución y del trade-off. Cerrar con la compra de oro y el evento global:
cada grupo entrega una fila PFGST y una alternativa descartada.
