...
\begin{document}
    ...
    \begin{table}[htbp]
        ...
        \begin{tabular}{p{0.28\textwidth}p{0.62\textwidth}}
            ...
            Defensa & 10 minutos de presentación y 5 minutos de preguntas del comité. Cualquier integrante puede ser consultado sobre cualquier decisión del trabajo. \\
            \bottomrule
        \end{tabular}
    ...
    El foco del trabajo está puesto en la gestión distribuida del estado del juego: las instancias, los combates, el oro, los objetos, las recompensas y las operaciones que los sostienen.
    Quedan fuera de alcance:

    \begin{itemize}
        \item El diseño de la interfaz gráfica del jugador: pantallas, navegación, animaciones y efectos visuales.
        Atención: esto excluye el diseño visual, no el comportamiento del cliente. Cómo reacciona la aplicación móvil ante una desconexión o un reintento sí forma parte del trabajo, porque es donde se originan las fallas de cliente (ver sección~\ref{sec:modelo-fallas}).
