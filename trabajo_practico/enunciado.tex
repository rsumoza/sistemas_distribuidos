...
\begin{document}
    ...
    \begin{table}[htbp]
        ...
        \begin{tabular}{p{0.28\textwidth}p{0.62\textwidth}}
            ...
            Dedicación estimada & Entre 18 y 24 horas de trabajo por equipo. \\
            Entregables & Documentación de los pares PFGST y defensa oral. \\
    ...
    El análisis no incluye la evaluación de la interfaz de usuario del jugador.
    El foco está puesto exclusivamente en la gestión interna de los elementos de juego, como las instancias, los combates, el oro, los objetos, las recompensas y las operaciones distribuidas que los sostienen.
    No es necesario analizar las animaciones visuales, los efectos gráficos ni el diseño de la interfaz gráfica.
