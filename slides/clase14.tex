...
\item ¿Qué mecanismo de Incidentes y cultura de confiabilidad es pertinente y cuál sería sobreingeniería?
...
\begin{frame}{No hay una sola causa raíz}
El disparador inicia el incidente; factores contribuyentes explican por qué se propagó, tardó en detectarse o fue difícil de mitigar.
\end{frame}
\begin{frame}{Acción verificable}
``Tener más cuidado'' no cambia el sistema. Una acción útil tiene owner, fecha, evidencia de cierre y relación explícita con un factor contribuyente.
\end{frame}
\begin{frame}{Checkpoint cultural}
Pregunte: ¿qué información y presiones hicieron razonable la decisión de la persona en ese momento? La respuesta revela mejoras sistémicas posibles.
\end{frame}
