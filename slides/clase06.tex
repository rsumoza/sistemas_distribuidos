...
\node[uaSoft,text width=2.05cm,right=0.48cm of dist,yshift=0.86cm] (n1) {Nodo A\\motor + medio persistente};
\node[uaSoft,text width=2.05cm,right=0.48cm of dist] (n2) {Nodo B\\motor + medio persistente};
\node[uaSoft,text width=2.05cm,right=0.48cm of dist,yshift=-0.86cm] (n3) {Nodo C\\motor + medio persistente};
...
\node[uaOrange,text width=1.65cm] (client) at (-5.35,0.35) {Cliente};
...
\node[anchor=west,font=\small\bfseries,text=UAIngNavy] at (0,5.30){Trabajo pendiente de compactación durante 10 minutos};
