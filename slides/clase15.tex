...
\item ¿Qué mecanismo de Diseño integral de sistemas distribuidos es pertinente y cuál sería sobreingeniería?
...
\begin{frame}{ADR: decisión trazable}
Cada decisión relevante debe registrar contexto, alternativas, decisión, consecuencias y evidencia pendiente. Esto permite revisar el diseño cuando cambian los supuestos.
\end{frame}
\begin{frame}{Architecture review basada en escenarios}
No preguntar solo ``¿escala?''. Recorrer escenarios: partición, dependencia lenta, duplicación, pérdida de región, pico de carga y operador equivocado.
\end{frame}
\begin{frame}{Checkpoint de defensa}
La arquitectura es defendible si puede explicar por qué la alternativa más simple no alcanza y en qué condición volvería a ser preferible.
\end{frame}
