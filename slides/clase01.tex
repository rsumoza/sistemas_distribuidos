...
\begin{frame}{Presentación}
    Vamos a hablar de sistemas distribuídos, donde múltiples componentes trabajan en conjunto.
    
    Vamos a analizar problemas y posibles soluciones de acuerdo a las restricciones y capacidades deseadas. 
\end{frame}
