...
Topic inicial & 24 particiones, RF=3 \\
Consumers principales & inventario, facturación, email y analítica \\
SLO inventario & 99,9\% de pedidos reflejados en menos de 5 s \\
Fallas a considerar & timeout de producer, crash de consumer, rebalance, hot key y evento tardío \\
\bottomrule
\end{tabular}
\end{center}
...
\textit{Entregable mínimo:} un schema de outbox/inbox, relay, retención y prueba de repetición.
\end{uaexercise}
\begin{uaexercise}
...
\textit{Entregable mínimo:} un diagrama de join, estado retenido, timeout y late-data policy.
\end{uaexercise}
\begin{uaexercise}
