...
\begin{uakeybox}
Resultado de aprendizaje esperado: al finalizar la clase, el estudiante debe ser capaz de explicar qué vuelve difícil este problema distribuido, razonar desde síntomas hacia causas posibles, documentar el relevamiento y el análisis, relevar, analizar y proponer en forma aislada y conectada, indicar qué garantía busca preservar y qué precio paga por hacerlo.
\end{uakeybox}
\end{document}
