...
La clase 12 no se estudia aislada: se conecta con RPC, replicación, consistencia, observabilidad o resiliencia según corresponda. El objetivo pedagógico es que el estudiante pueda trasladar el concepto de una situación puntual a una familia completa de problemas distribuidos.
...
\item OpenTelemetry docs.
\item Observabilidad en sistemas distribuidos modernos.
\end{itemize}
