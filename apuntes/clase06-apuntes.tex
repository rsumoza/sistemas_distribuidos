...
La clase 06 desarrolla el tema ``Quórums'' como una extensión directa del framework del curso. El foco no está puesto solamente en describir una técnica, sino en entender qué problema distribuye, qué hipótesis de falla la vuelven necesaria, qué garantía permite ofrecer y qué costo operativo introduce.

\section{Desarrollo conceptual}
Analizar cómo leer y escribir sobre réplicas usando intersección de quórums y parámetros N, R y W. Este tema debe pensarse siempre sobre un caso concreto: una operación, una lectura, una réplica, un log o un servicio remoto que necesita coordinarse con otros elementos del sistema. La clase discute cómo cambia la decisión de diseño cuando cambian las hipótesis de falla o las garantías exigidas por el dominio.

\subsection{Preguntas guía}
\begin{itemize}
\item ¿Cómo aparece N, R, W en un sistema real? \item ¿Cómo aparece intersección en un sistema real? \item ¿Cómo aparece lecturas y escrituras en un sistema real? 
...
La clase 06 no se estudia aislada: se conecta con RPC, replicación, consistencia, observabilidad o resiliencia según corresponda. El objetivo pedagógico es que el estudiante pueda trasladar el concepto de una situación puntual a una familia completa de problemas distribuidos.
...
\begin{itemize}
\item Kleppmann, cap. 5.
\item Dynamo paper.
\item Notas de clase sobre quórums y reconciliación.
\end{itemize}
