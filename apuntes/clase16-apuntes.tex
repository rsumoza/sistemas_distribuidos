...
La clase 16 no se estudia aislada: se conecta con RPC, replicación, consistencia, observabilidad o resiliencia según corresponda. El objetivo pedagógico es que el estudiante pueda trasladar el concepto de una situación puntual a una familia completa de problemas distribuidos.
...
\begin{itemize}
\item Relectura de apuntes del curso.
\item Defensas de proyectos.
\item Síntesis de decisiones bajo incertidumbre.
\end{itemize}
