...
La clase 08 no se estudia aislada: se conecta con RPC, replicación, consistencia, observabilidad o resiliencia según corresponda. El objetivo pedagógico es que el estudiante pueda trasladar el concepto de una situación puntual a una familia completa de problemas distribuidos.
...
\begin{itemize}
\item Kleppmann, cap. 6.
\item Dynamo paper.
\item Tanenbaum, particionado y distribución de datos.
\end{itemize}
